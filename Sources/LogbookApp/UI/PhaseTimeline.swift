...
enum TimelinePhaseStyle {
    ...
    var tint: Color {
        switch self {
        case .focus:
            return LogbookStyle.phaseFocus
        case .support:
            return LogbookStyle.phaseSupport
        case .drift:
            return LogbookStyle.phaseSupport
        case .breakState:
            return LogbookStyle.phasePause
        case .neutral:
            return LogbookStyle.phaseNeutral
        }
    }
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(LogbookStyle.secondaryCardFill)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)

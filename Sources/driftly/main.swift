...
enum DriftlyCLI {
    ...
    private static func printSessions(_ sessions: [StoredSession], includeAllDates: Bool) {
        ...
        print(includeAllDates ? "Driftly sessions" : "Today's sessions")
        print("")
    ...
    private static func printEvents(_ events: [ActivityEvent], limit: Int, includeAllDates: Bool) {
        ...
        print(includeAllDates ? "Driftly events" : "Today's events")
        print("")
    ...
    private static func printUsage() {
        print(
            ...
            Usage:
              driftly view [--events | --summary] [--limit N] [--all]
            
            Examples:
              swift run driftly view
              swift run driftly view --events --limit 10
              swift run driftly view --summary
              swift run driftly view --all
            """
        )
    }
